...
export const fetchReviews = createAsyncThunk('reviews/fetcgReviews',async(_, thunkAPI) => {
  try{
...
export const deletedReviews = createAsyncThunk('comments/deletedComments', async(id, thunkAPI) => {
  try {
